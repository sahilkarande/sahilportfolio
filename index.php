...
<head>
  ...
  <!--
      - favicon
      -->
  <link rel="shortcut icon" href="./assets/images/clipboard.ico" type="image/x-icon">
    ...
    <aside class="sidebar" data-sidebar>
      <div class="sidebar-info">
        ...
        <figure class="avatar-box">
          <img src="assets/images/profile_picture.png" alt="Sahil Karande" data-src="assets/images/Passport_photo.jpg" onclick="openModal(this)">
          <ion-icon name="eye-outline" class="eye-icon"></ion-icon>
        </figure>

        <div class="info-content">
          <h1 class="name" title="Sahil Karande">Sahil Karande</h1>
          <p class="title">B.Tech Graduate <br> Computer Engineering</p>
          <br>
    ...
    <div class="main-content">
      ...
      <nav class="navbar">
        <ul class="navbar-list">
          <div class="info-box">
            <p class="info-text">Profile Last Updated: <b>4th Sept 2024</b></p>
          </div>
